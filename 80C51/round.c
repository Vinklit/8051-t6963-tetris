...
/**
 * Suivant la direction de mouvement, tourne la pièce à gauche ou a droite, ou
 * déplace la pièce vers la gauche ou la droite.
 * @param piece La description de la pièce. La fonction modifie ses coordonnées
 * et son orientation.
 ...
 * @return 1 si la pièce peut encore descendre.
 */
